...
$root_path = str_replace($_SERVER['DOCUMENT_ROOT'], '', __DIR__ );
define('WP_HOME', env('WP_HOME', Request::createFromGlobals()->getSchemeAndHttpHost().$root_path));

// Set the WordPress directory path.
define('WP_SITEURL', env('WP_SITEURL', sprintf('%s/%s', WP_HOME, env('WP_DIR', ''))));
...
//define('WP_CONTENT_DIR', env('WP_CONTENT_DIR', ABSPATH.'wp-content') );
//define('WP_CONTENT_URL', env('WP_CONTENT_URL', WP_HOME) );

// Allows for the plugins directory to be moved from the default location.
//define('WP_PLUGIN_DIR', env('WP_PLUGIN_DIR', ABSPATH.'wp-content/plugins') );
//define( 'WP_PLUGIN_URL', env('WP_PLUGIN_URL', WP_CONTENT_URL . '/plugins') ); // Full URL, no trailing slash.

// Allows for the mu-plugins directory to be moved from the default location.
//define( 'WPMU_PLUGIN_DIR', env('WPMU_PLUGIN_DIR', WP_CONTENT_DIR . '/mu-plugins') ); // Full path, no trailing slash.
//define( 'WPMU_PLUGIN_URL', env('WPMU_PLUGIN_URL', WP_CONTENT_URL . '/mu-plugins') ); // Full URL, no trailing slash.
